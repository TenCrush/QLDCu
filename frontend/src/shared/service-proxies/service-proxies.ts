...
export class DanCuService {
    ...
    createOrEditDanCu(body: DanCuDto | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/DanCu/CreateOrEdit";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_: any) => {
            return this.processCreateOrEditDanCu(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateOrEditDanCu(<any>response_);
                } catch (e) {
                    return <Observable<boolean>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateOrEditDanCu(response: HttpResponseBase): Observable<boolean> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    getAllForView(): Observable<DanCuDtoResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            return this.processGetAllForView(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllForView(<any>response_);
                } catch (e) {
                    return <Observable<DanCuDtoResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<DanCuDtoResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAllForView(response: HttpResponseBase): Observable<DanCuDtoResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = DanCuDtoResultDto.fromJS(resultData200);
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<DanCuDtoResultDto>(<any>null);
    }



    getForEdit(id: number): Observable<DanCuDto> {
        let url_ = this.baseUrl + "/api/services/app/DanCu/GetForEdit?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<DanCuDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<DanCuDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetForEdit(response: HttpResponseBase): Observable<DanCuDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = DanCuDto.fromJS(resultData200);
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<DanCuDto>(<any>null);
    }
    ...
    delete(id: number): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/DanCu/Delete?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        if (data) {
            if (Array.isArray(data["items"])) {
                ...
                for (let item of data["items"])
                    this.items.push(DanCuDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): DanCuDtoResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new DanCuDtoResultDto();
        result.init(data);
        return result;
    }
...
export class DanCuDto {
    id: number | undefined;
    hoVaTen: number | undefined;
    ngaySinh: moment.Moment | undefined;
    nhomMau: number | undefined;
    gioiTinh: number | undefined;
    tinhTranHonNhan: number | undefined;
    noiDKKhaiSinh: string | undefined;
    queQuan: string | undefined;
    danToc: string | undefined;
    tonGiao: string | undefined;
    quocTich: string | undefined;
    cmnd: string | undefined;
    hoChieu: string | undefined;
    hocVan: string | undefined;
    chuyenMon: string | undefined;
    tiengDanToc: string | undefined;
    ngoaiNgu: string | undefined;
    ngheNghiep: string | undefined;
    noiLamViec: string | undefined;
    thuongTru: string | undefined;
    noiOHienNay: string | undefined;
    loai: number | undefined;
    sdt: string | undefined;
    hoVaTenMe: string | undefined;
    cmndMe: string | undefined;
    hoVaTenBo: string | undefined;
    cmndBo: string | undefined;
    hoVaTenVoChong: string | undefined;
    cmndVoChong: string | undefined;
    hoVaTenChuHoKhau: string | undefined;
    cccdChuHo: string | undefined;
    quanHeVoiChuHo: string | undefined;
    soSoHoKhau: string | undefined;
    hoVaTenChuSoHuuNhaDangO: string | undefined;
    quanHeVoiChuSoHuuNhaDangO: moment.Moment | undefined;
    sdtChuSoHuuNhaDangO: moment.Moment | undefined;
    tsTa: boolean | undefined;
    daChet: boolean | undefined;
    daDi: boolean | undefined;
    ngayDen: moment.Moment | undefined;
    ...
    init(data?: any) {
        if (data) {
            ...
            this.nhomMau = data["nhomMau"];
            this.gioiTinh = data["gioiTinh"];
            this.tinhTranHonNhan = data["tinhTranHonNhan"];
            this.noiDKKhaiSinh = data["noiDKKhaiSinh"];
            this.queQuan = data["queQuan"];
            this.danToc = data["danToc"];
            this.tonGiao = data["tonGiao"];
            this.quocTich = data["quocTich"];
            this.cmnd = data["cmnd"];
            this.hoChieu = data["hoChieu"];
            this.hocVan = data["hocVan"];
            this.chuyenMon = data["chuyenMon"];
            this.hocVan = data["hocVan"];
            this.tiengDanToc = data["tiengDanToc"];
            this.ngoaiNgu = data["ngoaiNgu"];
            this.ngheNghiep = data["ngheNghiep"];
            this.noiLamViec = data["noiLamViec"];
            this.thuongTru = data["thuongTru"];
            this.noiOHienNay = data["noiOHienNay"];
            this.loai = data["loai"];
            this.sdt = data["sdt"];
            this.hoVaTenMe = data["hoVaTenMe"];
            this.cmndMe = data["cmndMe"];
            this.hoVaTenBo = data["hoVaTenBo"];
            this.cmndBo = data["cmndBo"];
            this.hoVaTenVoChong = data["hoVaTenVoChong"];
            this.cmndVoChong = data["cmndVoChong"];
            this.hoVaTenChuHoKhau = data["hoVaTenChuHoKhau"];
            this.cccdChuHo = data["cccdChuHo"];
            this.quanHeVoiChuHo = data["quanHeVoiChuHo"];
            this.soSoHoKhau = data["soSoHoKhau"];
            this.hoVaTenChuSoHuuNhaDangO = data["hoVaTenChuSoHuuNhaDangO"];
            this.quanHeVoiChuSoHuuNhaDangO = data["quanHeVoiChuSoHuuNhaDangO"];
            this.sdtChuSoHuuNhaDangO = data["sdtChuSoHuuNhaDangO"];
            this.tsTa = data["tsTa"];
            this.daChet = data["daChet"];
            this.daDi = data["daDi"];
            this.ngayDen = data["ngayDen"] ? moment(data["ngayDen"].toString()) : <any>undefined;
            this.noiDen = data["noiDen"];
    ...
    static fromJS(data: any): DanCuDto {
        data = typeof data === 'object' ? data : {};
        let result = new DanCuDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["nhomMau"] = this.nhomMau;
        data["gioiTinh"] = this.gioiTinh;
        data["tinhTranHonNhan"] = this.tinhTranHonNhan;
        data["noiDKKhaiSinh"] = this.noiDKKhaiSinh;
        ...
        data["tiengDanToc"] = this.tiengDanToc;
        data["ngoaiNgu"] = this.ngoaiNgu;
        data["ngheNghiep"] = this.ngheNghiep;
        data["noiLamViec"] = this.noiLamViec;
        data["thuongTru"] = this.thuongTru;
        data["noiOHienNay"] = this.noiOHienNay;
        data["loai"] = this.loai;
        data["sdt"] = this.sdt;
        data["hoVaTenMe"] = this.hoVaTenMe;
        data["cmndMe"] = this.cmndMe;
        data["hoVaTenBo"] = this.hoVaTenBo;
        data["cmndBo"] = this.cmndBo;
        data["hoVaTenVoChong"] = this.hoVaTenVoChong;
        data["cmndVoChong"] = this.cmndVoChong;
        data["hoVaTenChuHoKhau"] = this.hoVaTenChuHoKhau;
        data["cccdChuHo"] = this.cccdChuHo;
        data["quanHeVoiChuHo"] = this.quanHeVoiChuHo;
        data["soSoHoKhau"] = this.soSoHoKhau;
        data["hoVaTenChuSoHuuNhaDangO"] = this.hoVaTenChuSoHuuNhaDangO;
        data["quanHeVoiChuSoHuuNhaDangO"] = this.quanHeVoiChuSoHuuNhaDangO;
        data["sdtChuSoHuuNhaDangO"] = this.sdtChuSoHuuNhaDangO;
        data["tsTa"] = this.tsTa;
        data["daChet"] = this.daChet;
        data["daDi"] = this.daDi;
